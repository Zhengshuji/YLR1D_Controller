#ifndef YLR1D_MID_CONTROL__JOINT_STATE_FILTER_HPP_
#define YLR1D_MID_CONTROL__JOINT_STATE_FILTER_HPP_
...
#endif  // YLR1D_MID_CONTROL__JOINT_STATE_FILTER_HPP_
