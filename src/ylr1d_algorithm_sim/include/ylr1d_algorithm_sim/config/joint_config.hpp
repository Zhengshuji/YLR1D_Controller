#ifndef YLR1D_ALGORITHM_SIM__CONFIG__JOINT_CONFIG_HPP_
#define YLR1D_ALGORITHM_SIM__CONFIG__JOINT_CONFIG_HPP_
...
/// is_position=true → 位置型（1/s²，如 SteeringPlant）；false → 速度型（1/s，如 WheelPlant）。
...
#endif  // YLR1D_ALGORITHM_SIM__CONFIG__JOINT_CONFIG_HPP_
